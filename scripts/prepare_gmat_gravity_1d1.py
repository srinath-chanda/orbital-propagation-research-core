"""Prepare the Research Core 1D.1 GMAT short-arc matrix."""
...
from research_core.gmat_gravity_short_arc import prepare_gravity_short_arc
...
def main() -> int:
    ...
    print("=" * 78)
    try:
        result = prepare_gravity_short_arc(
        ...
        return 1
    print("\nGMAT 1D.1 HIGHER-DEGREE SHORT-ARC FILES PREPARED")
    ...
    print("\nNext: run RUN_GRAVITY_SHORT_ARCS_1D1.script once in GMAT R2026a.")
    return 0
